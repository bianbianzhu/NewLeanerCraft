...
class DrawDashedCurvedLine extends CustomPainter {
  //for lines, the style should be stroke
  final Color color;
  final double strokeWidth;
  final PaintingStyle paintingStyle;
...
//          unitHeight * 1.5);
    ...
    Path _path = Path()
      ..moveTo(0, 0)
      ..lineTo(unitWidth * 1, unitHeight)
      ..lineTo(unitWidth * 2, 0)
      ..lineTo(unitWidth * 3, unitHeight)
      ..lineTo(unitWidth * 4, 0)
      ..lineTo(unitWidth * 5, unitHeight)
      ..lineTo(unitWidth * 6, 0)
      ..lineTo(unitWidth * 7, unitHeight)
      ..lineTo(unitWidth * 8, 0)
      ..lineTo(unitWidth * 9, unitHeight)
      ..lineTo(unitWidth * 10, 0)
      ..lineTo(unitWidth * 11, unitHeight)
      ..lineTo(unitWidth * 12, 0);
